...
For simplicity, engine size was chosen as the predictor variable for CO₂ emissions.
The dataset was split into training (80%) and testing (20%) subsets using Scikit-Learn.
